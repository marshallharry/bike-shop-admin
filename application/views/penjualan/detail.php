<?php
    ...
    $grandModal = $header->Modal;
    $laba = $grandTotal - $grandModal;
    $headerid = $header->ID;
?>
...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <div class="form-group">
                                        <label>Tanggal Jual : <?= $header->Tanggal ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Total Jual : <?= number_format($grandTotal) ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Total Modal : <?= number_format($grandModal) ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label>Total Laba : <?= number_format($laba) ?></label>
                                    </div>
                                </div>
                                <!-- /.table-responsive -->
                            </div>
                ...
                <form id="returForm" action="<?= $baseUrl ?>penjualan/retur" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                    ...
                    <input type="hidden" value="<?= $grandModal ?>" name="txModal" id="txModal" />
                </form>
            </div>
            <!-- /.container-fluid -->
        </div>
        ...
        function confirmDelete(id, headerid) {
            ...
            if (password != null) {
                $.post("<?= $baseUrl.'user/validate_password/' ?>", {password: password}, function(result){
                    if(result == "true") {
                        window.location.href = "<?= $baseUrl.'penjualan/remove_detail/' ?>"+headerid+"/"+id
                    }
                    else {
