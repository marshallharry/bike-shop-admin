...
class Pembelian_model extends CI_Model {
	...
	public function get_detail_pembelian($headerid, $id = null)
	{
		if($id != null) 
		{
			$this->db->select('detail_pembelian.ID, detail_pembelian.Nama_Barang, detail_pembelian.Modal_Barang, detail_pembelian.Jumlah, detail_pembelian.Barang_ID, detail_pembelian.Diskon, detail_pembelian.PPN');
    ...
    public function add_detail_pembelian($id_barang, $jumlah, $headerid, $modal, $nama, $diskon, $ppn) {
    	$param = array(
			'Header_ID' => $headerid,
			'Barang_ID' => $id_barang,
			'Jumlah' => $jumlah,
